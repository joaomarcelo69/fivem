...
-- tabela simples de montantes, pode migrar para config se necessário
local function calcFine(kmhOver, limit, zone)
  -- escala aproximada PT: mais pesada em urbana e para >40/60kmh over
  local base
...
AddEventHandler('pt-speedcams:server:overspeed', function(camId, plate, speed, limit)
  ...
  -- emitir multa via sistema existente, se existir
