        ...
        if (CanOpenApp) {
            if (QB.Phone.Data.currentApplication == null) {
                ...
                if (PressedApplication == "settings") {
                    ...
                    // Abrir o painel de Habitação (pt-housing) diretamente a partir do telemóvel
                    $.post('https://qb-phone/OpenPtHousing', JSON.stringify({}));
                    ...
                    QB.Phone.Functions.Close();
                } else if (PressedApplication == "orders") {
                    // Abrir Orders UI interno ao telefone
                    QB.Phone.Animations.TopSlideDown('.phone-application-container', 300, 0);
                    QB.Phone.Functions.ToggleApp('orders', 'block');
                    QB.Phone.Data.currentApplication = 'orders';
                    $.post('https://qb-phone/PtOrdersInit', JSON.stringify({}));
                }
